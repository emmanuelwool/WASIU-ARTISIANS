...
const Google = (props: SVGProps<SVGSVGElement>) => (
  <svg
    {...props}
    // Correction: Remplacer 'xmlns:xlink' par 'xmlnsXlink'
    xmlnsXlink="http://www.w3.org/1999/xlink" 
    // Correction: Remplacer 'xmlSpace' par 'xmlSpace' (déjà en camelCase, on le garde)
    xmlSpace="preserve"
    // Cet attribut est souvent inutile en React, mais je le laisse.
    overflow="hidden"
